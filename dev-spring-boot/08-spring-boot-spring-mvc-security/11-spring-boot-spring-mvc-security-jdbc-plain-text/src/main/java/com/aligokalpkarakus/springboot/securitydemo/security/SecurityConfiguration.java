...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(configurer ->
                ...
                // Kimlik doğrulamasından geçen kullanıcılar için log out sağlar.
                // Bize çıkış için varsayılan URL olan /logout'u ortaya çıkaracak çıkış desteği sağlar.
                .logout(logout -> logout.permitAll()
                )
                // Rolünün izin vermediği bir yere girmeye çalıştığında gelecek olan custom denied page.
                // Kullanıcıyı /access-denied URL'sine iletecek.
