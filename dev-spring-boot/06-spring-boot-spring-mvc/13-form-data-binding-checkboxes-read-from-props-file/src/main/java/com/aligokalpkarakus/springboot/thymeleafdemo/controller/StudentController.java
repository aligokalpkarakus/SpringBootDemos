...
public class StudentController {
    ...
    */
    ...
    /*
     Radio butonlarında dilleri göstermeyi bir liste aracılığıyla yapmak istiyoruz.
     Listenin elemanlarını application.properties'de verdik. App properties'den bu elemanları bu listeye
     inject edeceğiz. Orada "languages" adlı değişkenimize vermiştik dilleri. Bu yüzden anotasyonda da onu veriyoruz
    */
    @Value("${languages}")
    private List<String> languages;

    /*
     Checkboxes'da sistemleri göstermeyi bir liste aracılığıyla yapmak istiyoruz.
     Listenin elemanlarını application.properties'de verdik. App properties'den bu elemanları bu listeye
     inject edeceğiz. Orada "systems" adlı değişkenimize vermiştik dilleri. Bu yüzden anotasyonda da onu veriyoruz
    */
    @Value("${systems}")
    ...
    public String showForm(Model model) {
        ...
        // Languages listemizi modele yüklüyoruz.
        model.addAttribute("languages", languages);

        // Systems listemizi modele yüklüyoruz.
