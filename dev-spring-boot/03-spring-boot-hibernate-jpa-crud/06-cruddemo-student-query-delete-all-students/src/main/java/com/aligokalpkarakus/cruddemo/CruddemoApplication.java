	...
	*/
	...
	public CommandLineRunner commandLineRunner(StudentDAO studentDAO) {
		...
		return runner -> {
			...
			//Öğrenciyi veritabanında güncellemek için method.
			//updateStudent(studentDAO);

			//Öğrenciyi veritabanından silmek için method.
			//deleteStudent(studentDAO);

			//Tüm öğrencileri veritabanından silip, silinen row sayısını yazdıran method.
	...
	private void deleteStudent(StudentDAO studentDAO) {
		...
		//retrieve student and delete based on the id: primary key
		int studentId = 3;
	...
	private void updateStudent(StudentDAO studentDAO) {
		...
		System.out.println("Before updating student: " + student);
		...
		System.out.println("After updateding student: " + student);
	}
