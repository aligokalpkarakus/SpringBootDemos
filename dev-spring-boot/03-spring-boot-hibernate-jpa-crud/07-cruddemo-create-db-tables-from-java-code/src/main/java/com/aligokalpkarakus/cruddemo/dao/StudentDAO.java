...
public interface StudentDAO {
    ...
    // ID ile belirtilen öğrenciyi veritabanından silmek için method
    void delete(Integer id);

    // Veritabanındaki tüm öğrencileri silmek için method. Kaç satır silindi öğrenmek içini int tipinde yazıyoruz.
    int deleteAll();
}
