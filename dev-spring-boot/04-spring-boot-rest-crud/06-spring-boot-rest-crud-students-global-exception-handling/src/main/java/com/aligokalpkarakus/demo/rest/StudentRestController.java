...
public class StudentRestController {
    ...
    /* Uygulamanın büyük olduğu durumlarda yapmamız gereken şey global exception handler yapmak.
       Bunu yapmak için de StudentRestGlobalExceptionHandler class'ı açtık. Bu iki metodu oraya yapıştırdık
