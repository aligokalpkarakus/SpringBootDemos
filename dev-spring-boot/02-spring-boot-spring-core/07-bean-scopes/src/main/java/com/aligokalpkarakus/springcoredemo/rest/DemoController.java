...
public class DemoController {
    ...
    aynı bean'i referans alacak. Bu yüzden true dönecek. Eğer protoype olsaydı singleton yerine false dönerdi.
     */
    @GetMapping("/check")
    public String check() {
        return "comparing anotherCoach and myCoach: " + (anotherCoach == myCoach);
    }
}
